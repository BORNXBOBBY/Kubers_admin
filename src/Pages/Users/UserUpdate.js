          ...
          <div className="row">
            <div className="col-12 py-4">
              <div className="rounded   p-3">
                <h2 className="text-center"  style={{fontWeight: 500 , color: "#0e2238"}}>User Details</h2>
                <hr />
                <div className="row">
                  <h5 className="ps-1 ps-md-4" style={{ color: "#0e2238", fontWeight: "500" }}>
                  ...
                  <Box>
                    <div className="row px-4 mt-3">
                      ...
                      <div className="col-md-6 mt-3">
                        <label className="form-label"  style={{fontWeight: 500}}>Mobile</label>
                        <input
                          type=""
                          className="form-control"
